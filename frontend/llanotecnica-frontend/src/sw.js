...
// Version 2.0 - Phase 2C Performance Optimization

const CACHE_NAME = 'llanotecnica-v2.0';
const STATIC_CACHE = 'llanotecnica-static-v2.0';
const DYNAMIC_CACHE = 'llanotecnica-dynamic-v2.0';
